#!/usr/bin/env Rscript
# Convert RenalUrothelium_cells.h5ad → RenalUrothelium_cells.rds (Seurat object)
...
h5ad_path <- file.path(base_dir, "integration_output", "RenalUrothelium_cells.h5ad")
rds_path  <- file.path(base_dir, "integration_output", "RenalUrothelium_cells.rds")

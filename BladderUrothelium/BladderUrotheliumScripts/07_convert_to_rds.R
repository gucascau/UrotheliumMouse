#!/usr/bin/env Rscript
# 07_convert_to_rds.R — Convert bladder urothelial h5ad to a
# Seurat RDS object, transferring all scVI/UMAP reductions.
#
# Input  : output/BladderUrothelium_uro_cells_scvi.h5ad
# Output : output/BladderUrothelium_uro_cells_scvi.rds
...
h5ad_path <- file.path(out_dir, "BladderUrothelium_uro_cells_scvi.h5ad")
rds_path  <- file.path(out_dir, "BladderUrothelium_uro_cells_scvi.rds")
...
for (red in c("X_scVI", "X_umap_scVI", "X_umap")) {
